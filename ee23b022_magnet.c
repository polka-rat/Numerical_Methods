...
int main(int argc,char* argv[]){
	...
	while(theta<=theta_stop){            //Euler's Curve
		...
		//phi+=phi_slope*delta_t;
		//phi_sum+=phi;  //since rate of change of phi is invariant of time
		phi_count++;
	...
	r_square_e(&r2_etheta,&r2_ephi,euler_theta_avg,euler_phi_avg);
	...
	r_square_h(&r2_htheta,&r2_hphi,heun_theta_avg,heun_phi_avg);
